...
// Custom implementation of KoinComponent to prevent issues with other plugins also using Koin, make sure to import all you want from this Koin.kt file instead of the default Koin lib
@KoinApiExtension
